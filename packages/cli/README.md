...
The v0.3.0 Alpha Capability Release CLI supports YAML-only source files,
`diagrampilot generate` for configured Derived Artifacts and Markdown embed
files, `diagrampilot export --format dot`, `diagrampilot render --format png`,
and `diagrampilot mcp` for the alpha MCP server.
