...
const diagramspecV1SchemaId =
  "https://diagrampilot.com/schema/diagramspec-v1.schema.json";
const iconReferenceSchemaPattern = "^[a-z][a-z0-9-]*:[^\\s:]+$";
const metadataSourceReferenceSchemaPattern =
  "^(?![A-Za-z][A-Za-z0-9+.-]*:)(?!/)(?!//)\\S(?:.*\\S)?$";
const metadataExternalUrlSchemaPattern = "^https?://[^\\s/?#]+(?:[/?#].*)?$";
