...
const provenanceSourcePath = "docs/architecture.dp.yaml";
...
const emptySvg = '<svg xmlns="http://www.w3.org/2000/svg"><g /></svg>';

function expectedSvgFreshnessOptions(sourcePath) {
  return {
    sourcePath,
...
async function writeProvenanceFixture(tempRoot, provenance) {
